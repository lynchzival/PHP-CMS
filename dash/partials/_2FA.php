<div class="card-body">
    <h3 class="card-title text-center">2FA</h3>
    <div class="card-text">
        ...
        <form method="GET" class="register-form" id="login-form" action="auth/includes/2fa.php">
            <div class="form-group">
                <label for="exampleInputEmail1">6 Digits Code</label>
                <input type="text" class="form-control form-control-sm" name="verify_token" maxlength="6" id="exampleInputEmail1" aria-describedby="emailHelp">
            </div>
